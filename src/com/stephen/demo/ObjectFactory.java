 ...
 * generated in the com.stephen.demo package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://demo.stephen.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://demo.stephen.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.stephen.demo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.stephen.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo.stephen.com/", name = "getValueResponse")
